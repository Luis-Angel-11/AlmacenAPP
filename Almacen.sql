...
INSERT INTO `clientes` VALUES ('sadasd','1231231','asdasd','Masculino','asdasd','d2321','asdasd'),('1231231','Javierxd','asdasd','Masculino','asdasd','d2321','asdasd'),('123123','','','Seleccionar','','',''),('123123123','asdasd','asdasd','Femenino','asdads','123123','asdads'),('733188822','wqeqw','asdasd','Femenino','asd','asdasd','asdads'),('123123432','asd','asd','Masculino','asd','asd','asd');
...
CREATE TABLE `producto` (
  ...
  `estado` enum('Activo','Inactivo','Discontinuado') COLLATE utf8mb4_general_ci DEFAULT 'Activo',
...
) ENGINE=InnoDB AUTO_INCREMENT=6745624 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `producto` VALUES (1412459,'Hals',0.2,100,3,NULL,'Activo','Snak'),(2531341,'Cañonaso',2,45,4,NULL,'Activo','Snak'),(5124122,'Lays',4,25,5,NULL,'Activo','Snak'),(5412515,'BubaLu',0.1,200,2,NULL,'Activo','Snak'),(5625232,'PizzaCongelada',20,19,3,NULL,'Activo','Comida'),(6745623,'CocaCola',6,15,3,NULL,'Activo','Bebida');
...
-- Dump completed on 2024-12-10 17:35:20
